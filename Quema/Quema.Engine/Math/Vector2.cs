...
namespace Quema.Engine.Math
{
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        {
            value.X = (float)System.Math.Ceiling(value.X);
            value.Y = (float)System.Math.Ceiling(value.Y);
            return value;
        }
        ...
        {
            result.X = (float)System.Math.Ceiling(value.X);
            result.Y = (float)System.Math.Ceiling(value.Y);
        }
        ...
        {
            value.X = (float)System.Math.Floor(value.X);
            value.Y = (float)System.Math.Floor(value.Y);
            return value;
        }
        ...
        {
            result.X = (float)System.Math.Floor(value.X);
            result.Y = (float)System.Math.Floor(value.Y);
        }
        ...
        {
            result.X = (float)System.Math.Round(value.X);
            result.Y = (float)System.Math.Round(value.Y);
        }
